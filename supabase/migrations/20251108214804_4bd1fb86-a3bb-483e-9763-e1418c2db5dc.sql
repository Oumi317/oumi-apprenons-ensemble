-- Fonction pour vérifier les chevauchements de sessions
...
-- Créer le trigger
DROP TRIGGER IF EXISTS prevent_session_overlap ON sessions_tutorat;
CREATE TRIGGER prevent_session_overlap
  BEFORE INSERT OR UPDATE ON sessions_tutorat
  FOR EACH ROW
